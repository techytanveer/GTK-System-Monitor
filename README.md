...
## 9. Deployability
Shift is ready for distribution. It includes a *CMake* configuration compatible with CPack, enabling the generation of *.deb* & *.rpm* packages for easy installation on Debian-based systems.
